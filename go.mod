...
require (
	...
	github.com/operator-framework/operator-lifecycle-manager v0.23.1 // indirect
...
replace (
	github.com/openshift/api => github.com/openshift/api v0.0.0-20231025170628-b8a18fdc040d
