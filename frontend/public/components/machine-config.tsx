...
const MachineConfigSummary: React.SFC<MachineConfigSummaryProps> = ({ obj, t }) => (
  <ResourceSummary resource={obj}>
    <dt>{t('machine-configs~OS image URL')}</dt>
...
const MachineConfigList: React.SFC<any> = (props) => {
  ...
  const MachineConfigTableHeader = () => {
    return [
      {
        title: t('machine-configs~Name'),
        sortField: 'metadata.name',
        transforms: [sortable],
        props: { className: tableColumnClasses[0] },
      },
      {
        title: t('machine-configs~Generated by controller'),
        sortField:
      ...
      {
        title: t('machine-configs~Ignition version'),
        sortField: 'spec.config.ignition.version',
        transforms: [sortable],
        props: { className: tableColumnClasses[2] },
      },
      {
        title: t('machine-configs~OS image URL'),
        sortField: 'spec.osImageURL',
        transforms: [sortable],
        props: { className: tableColumnClasses[3] },
      },
      {
        title: t('machine-configs~Created'),
  ...
  return (
    <Table
      {...props}
      aria-label={t('machine-configs~MachineConfigs')}
